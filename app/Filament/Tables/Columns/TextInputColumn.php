...
use Filament\Tables\Columns\TextInputColumn as BaseColumn;
use Filament\Notifications\Notification;
use Illuminate\View\ComponentAttributeBag;

class TextInputColumn extends BaseColumn implements HasEmbeddedView
{
    public function updateState(mixed $state): mixed
    {
        ...
        Notification::make()
            ...
            ->body('O campo foi atualizado com sucesso.')
            ->send();
